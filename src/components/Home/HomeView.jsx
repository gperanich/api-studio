                ...
                <Grid.Row className='home-background'>
                    <Grid.Column className='header-jumbo' >
                        ...
                        <div style={{ textApgn: 'center' }}>
                            ...
                            <Button content='Sign Up / Sign In' />
                        </div>
                    </Grid.Column>
                </Grid.Row>
                <Grid.Row >
                    {/*<Grid.Column className='info-div'>
                        <div>
                            <div className='info-section'>
                                <h2>Major Capabipties</h2>
                                    <p>Catalog APIs</p>
                                    <p>Connect with other companies</p>
                                    <p>Completely customize your site with a CMS</p>
                            </div>
                        </div>
                    </Grid.Column>*/}
                    ...
                    <Grid.Column width={8}>
                        <div className='catalog-info' >
                            <List size='large'>
                                ...
                                <List.Item className='list-item'>
                                    <List.Content>
                                        <List.Header>Control</List.Header>
